...
namespace ProfitFlowBackend.Services
{
    public class UserService
    {
        ...
        public UserService(UserManager<Usuario> userManager, IMapper mapper, SignInManager<Usuario> signInManager, TokenService tokenService, ProfitFlowDbContext context)
        {
        ...
        public async Task Cadastra(CreateUserDtos dto)
        {
